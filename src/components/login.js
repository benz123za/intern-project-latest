import { Button, TextInput, TextTextInput } from "flowbite-react";
...
const Login = () => {
  return (
    <div>
      <div class="w-full mx-auto bg-transparent rounded-lg md:mt-0 sm:max-w-lg xl:p-0 lg:col-span-7 xl:col-span-6">
        <div class="p-6 space-y-4 lg:space-y-6 sm:p-8">
          <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 sm:text-2xl dark:text-">
            ลงชื่อเข้าใช้งาน
          </h1>
          <div class="items-center space-y-3 sm:space-x-4 sm:space-y-0 sm:flex">
            <a
              href="#"
              class="w-full inline-flex items-center justify-center py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus-gray-700 dark:bg-gr0 dark:text-400 dark:bordey-600 dark:hover-white dark:hoverray-700"
            >
              <svg
                class="w-5 h-5 mr-2"
                viewBox="0 0 21 20"
            ...
            >
              <svg
                class="w-5 h-5 mr-2 text-gray-900 dark:text-"
                viewBox="0 0 21 20"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div class="flex items-center">
            <div class="w-full h-0.5 bg-gray-200 dark:bg-gr0"></div>
            <div class="px-5 text-center text-gray-500 dark:text-400">or</div>
            <div class="w-full h-0.5 bg-gray-200 dark:bg-gr0"></div>
          </div>
          <form class="space-y-4 lg:space-y-6" action="#">
            <div>
              ...
              <TextInput
                ...
                name="email"
                id="email"
                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gr0 dark:bordey-600 dark:placer-gray-400 dark:text- dark:focus-blue-500 dark:focuser-blue-500"
            ...
            <div class="flex items-start">
              <div class="flex items-center h-5">
                <TextInput
                  ...
                  type="checkbox"
                  class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gr0 dark:bordey-600 dark:focus-primary-600 dark:ring-t-gray-800"
                  required=""
                />
              </div>
              <div class="ml-3 text-sm">
                <label
                  for="terms"
                  class="font-light text-gray-500 dark:text-300"
                >
                  By signing up, you are creating a Flowbite account, and you
                  agree to Flowbite’s{" "}
                  <a
                    class="font-medium text-primary-600 dark:text-ry-500 hover:underline"
                    href="#"
                  >
                    Terms of Use
                  </a>{" "}
            ...
            <Link href={"../register"}>
              <Button
                type="submit"
                className="w-full text-black bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-pr-600 dark:hoverrimary-700 dark:focus-primary-800"
              >
                Create an account
              </Button>
            </Link>
            <p class="text-sm font-light text-gray-500 dark:text-400">
              Already have an account?{" "}
              <a
                href="../register"
                class="font-medium text-primary-600 hover:underline dark:text-ry-500"
              >
                Sign in here
              </a>
            </p>
