    ...
    <div>
      <div class="flex justify-center items-center py-6 px-4 lg:py-0 sm:px-0">
        <form class="space-y-4 max-w-md md:space-y-6 xl:max-w-xl" action="#">
          <h2 class="text-xl font-bold text-gray-900 dark:text-black">
            ยินดีต้อนรับ
          </h2>
          <div class="items-center space-y-3 space-x-0 sm:flex sm:space-x-4 sm:space-y-0">
            <a
              href="#"
              class="w-full inline-flex items-center justify-center py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-black rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-black dark:hover:bg-gray-700"
            >
              <svg
                class="mr-2 w-5 h-5"
                viewBox="0 0 21 20"
            ...
            >
              <svg
                class="mr-2 w-5 h-5 text-gray-900 dark:text-black"
                viewBox="0 0 21 20"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div>
            ...
            <TextInput
              ...
              name="full-name"
              id="email"
              class="bg-gray-50 border border-blue-grey text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black"
          ...
          <div>
            ...
            <TextInput
              ...
              name="email"
              id="email"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black"
          ...
          <div class="space-y-3">
            <div class="flex items-start">
              ...
              <div class="ml-3 text-sm">
                ...
                >
                  โดยการลงทะเบียน คุณกำลังสร้างบัญชี Affiliate
                  และคุณยอมรับข้อกำหนดการใช้งานและนโยบายความเป็นส่วนตัวของเว็บไซต์
                </label>
              </div>
            </div>
          </div>
          <Button
            type="submit"
            className="w-full text-white bg-blue-grey hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 flex justify-center items-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-700"
          >
            สมัครใช้งาน
          </Button>
